...
<html>
    ...
    <body>
        ...
        <?php
        echo '<ul id="aSlider">';
        echo '<li>' . 'slider content' . '</li>';

        class Slider {

            private $numberOfSlides;

            public function outputSlides() {
        ...
        class Slide extends Slider {
            ...
            public function renderHtml() {
                return '<img src="' . $this->src . '" alt="' . $this->alt_text . '" width="' . $this->width . '" height="' . . '" />';
            }
            ...
            function content() {
                // HTML output generator of all sliders
            }

            $mainSlider->content();
            ?>
        <li><?php echo '<img height="300" width="300" src="images/00.jpg" />'; ?></li>
